...
const incomeStatementsTool = tool(
  async (input) => {
    console.log("--- incomeStatementsTool ---");
    try {
...
const cashFlowStatementsTool = tool(
  async (input) => {
    console.log("--- cashFlowStatementsTool ---");
    try {
